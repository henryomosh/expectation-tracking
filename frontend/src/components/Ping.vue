  ...
  <div class="text-center text-gray-800 py-20 px-6 lg:px-20">
    <div class="p-6 shadow-lg rounded-lg bg-indigo-100 text-gray-700">
      ...
      <p class="whitespace-normal py-6">
        This is a simple signup and sign in project that allows authenticated
        users to manage team expectations. Authenticated users can track
        expectation of each team member. They can access information such as
        what to expect, when to be done, when the expectation was created and
        the author of the expectation.
      </p>
      <button
        type="button"
        class="
